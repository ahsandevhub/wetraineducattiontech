...
function CheckoutPageContent() {
  ...
  const isServicePurchase = Boolean(service && id);
          ...
          {pkg || (name && price) ? (
            <>
                ...
                {isServicePurchase && (
                  <div className="mb-4">
                    <span className="inline-block rounded-full bg-blue-100 px-3 py-1 text-sm font-medium text-blue-700">
                      ...
                      {service === "it-service" && "💻 IT Service"}
                      {service === "marketing" && "📱 Marketing Service"}
                    </span>
                  </div>
                )}
              ...
              <p className="mb-6 text-gray-700">
                ...
                <span className="font-bold">{name}</span> for{" "}
          ...
          {!emailLocked && userEmail && (
            ...
            >
              <p className="text-sm text-green-700">
                ✨ <strong>New here?</strong> No problem! We&apos;ll instantly
                create your account during checkout. You&apos;ll receive a magic
                link to confirm your email and set your password.
              </p>
            </motion.div>
          )}
